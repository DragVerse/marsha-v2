    ...
    <Dialog.Root open={show} onOpenChange={setShow}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          className={tw(
            sizeClasses,
            "dragverse-border fixed top-[50%] left-[50%] z-10 max-h-[85vh] w-[90vw] translate-x-[-50%] translate-y-[-50%] space-y-4 rounded-xl bg-white p-5 focus:outline-none dark:bg-brand"
          )}
        >

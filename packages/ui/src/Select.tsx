...
>(({ children, className, size = 'md', ...props }, ref) => {
  ...
  return (
    <SelectPrimitive.Item
      className={tw(
        sizeClasses,
        'dark:hover:bg-brand-600 dark:data-[highlighted]:bg-brand-600 relative flex select-none items-center justify-between space-x-2 rounded-md leading-none hover:bg-gray-100 data-[disabled]:pointer-events-none data-[highlighted]:bg-gray-200 data-[state=checked]:font-semibold data-[highlighted]:outline-none',
        className
      )}
      ref={ref}
      {...props}

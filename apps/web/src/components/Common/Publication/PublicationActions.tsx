...
import { type MirrorablePublication, TriStateValue } from "@dragverse/lens";
import {
  CollectOutline,
  MirrorOutline,
  Modal,
...
const PublicationActions: FC<Props> = ({ publication }) => {
  ...
  return (
    <div className="mt-4 flex justify-end space-x-1">
      <div className="dragverse-border flex items-center justify-end overflow-hidden rounded-full bg-gray-100 dark:bg-brand-600">
        <PublicationReaction
          publication={publication}
          textSize="inherit"
          iconSize="base"
          className="flex items-center px-4 py-1 hover:bg-gray-200 dark:hover:bg-brand-250/50"
        />
        {publication.operations.canComment !== TriStateValue.No ? (
          <>
            <button
              ...
              className="flex items-center space-x-1 px-4 py-1 hover:bg-gray-200 dark:hover:bg-brand-250/50"
            >
        ...
        <OpenActions publication={publication}>
          <div className="flex items-center space-x-1 px-4 py-1 hover:bg-gray-200 dark:hover:bg-brand-250/50">
      ...
      <PublicationOptions publication={publication}>
        <button
          type="button"
          className="dragverse-border flex items-center space-x-1 rounded-full bg-gray-100 p-2 hover:bg-gray-200 dark:bg-gray-900 dark:hover:bg-gray-800"
        >

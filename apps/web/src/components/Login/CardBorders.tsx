const CardBorders = () => {
  return (
    <>
      <div className="dragverse-border -left-[8.5px] -top-[8.5px] absolute h-4 w-4 rounded-full" />
      ...
      <div className="dragverse-border -right-[8.5px] -top-[8.5px] absolute h-4 w-4 rounded-full" />
      ...
      <div className="dragverse-border -bottom-[8.5px] -right-[8.5px] absolute h-4 w-4 rounded-full" />
      ...
      <div className="dragverse-border -bottom-[8.5px] -left-[8.5px] absolute h-4 w-4 rounded-full" />

        ...
        <div className="mx-auto flex w-full max-w-screen-xl items-center space-x-4 px-2 md:pt-1 xl:px-0">
          <div className="flex w-full py-4">
            <div className="flex flex-1 flex-col space-y-2">
              <div className="col-span-2 h-5 rounded bg-gray-200 md:w-1/4 dark:bg-brand-950" />
              <div className="col-span-2 h-4 rounded bg-gray-200 md:w-1/6 dark:bg-brand-950" />
            </div>
            <div className="hidden gap-3 md:flex md:flex-col md:items-end">
              <ButtonShimmer />
              <div className="col-span-2 h-4 w-44 rounded bg-gray-200 dark:bg-brand-950" />
            </div>
          </div>
        </div>
      </div>

    ...
    <div className="mx-auto grid max-w-screen-ultrawide grid-cols-1 gap-y-4 md:gap-4 xl:grid-cols-4">
      <div className="col-span-3">
        ...
        <div className="mt-3 flex flex-1 animate-shimmer flex-col space-y-3.5">
          <div>
            <div className="my-2 h-5 w-full rounded-md bg-gray-200 dark:bg-brand-950" />
          ...
          <div className="my-4 flex items-center justify-end space-x-3">
            <div className="h-6 w-10 rounded-md bg-gray-200 dark:bg-brand-950" />
            <div className="h-6 w-10 rounded-md bg-gray-200 dark:bg-brand-950" />
            <div className="h-6 w-20 rounded-md bg-gray-200 dark:bg-brand-950" />
          </div>
        </div>
      </div>
